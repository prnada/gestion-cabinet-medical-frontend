    ...
    useEffect(() => {
      ...
      function sendRendezVous() {
       ...
       /////mail
        ...
        const selectedPatient = patients.find((patient) => patient.id === parseInt(patientRef.current.value, 10));
        const selectedMedecin = medecins.find((medecin) => medecin.id === parseInt(medecinRef.current.value, 10));
    
        if (!selectedPatient || !selectedMedecin) {
        ...
        const  patientTemplateParams = {
          ...
          nomPatient: selectedPatient.nomP+' '+selectedPatient.prenomP,
...
<div className="wrapper">
    <div class="body-overlay"></div>
        ...
        <div id="content">
          ...
          <a href='/rendez-vous' type="button" className="btn btn-primary" data-dismiss="modal">Revenir</a>
